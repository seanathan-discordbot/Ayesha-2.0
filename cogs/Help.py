    ...
    async def tutorial(self, ctx, topic : Option(str,
        ...
        if topic == "Simple":
            ...
            page5 = (
                ...
                f"an integral part of levelling up your weapons. Note that on "
                f"the first page of your profile is the 'Location' setting, "
                f"and you're most likely in Aramithea, the capital city of "
                f"Ayesha (use `/offices` or `/territories` to view the cool, "
                f"original map:TM: I made). You may have also discovered the "
                f"'Backpack', or the third page of `/profile` listing even "
                f"more stuff you need to get. If you have grown attached to "
                f"one of your acolytes, you can use the `/acolyte` command "
                f"to get detailed information about a specific acolyte.\n\n"
