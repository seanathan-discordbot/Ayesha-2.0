...
CREATE TABLE public.lightning_wins (
    ...
    player_name text DEFAULT 'Unknown Player'::text NOT NULL
);
...
--
-- Name: word_review; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.word_review OWNER TO postgres;

--
-- Name: word_review_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.word_review_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.word_review_id_seq OWNER TO postgres;

--
-- Name: word_review_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.word_review_id_seq OWNED BY public.word_review.id;
...
--
-- Name: word_review id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.word_review ALTER COLUMN id SET DEFAULT nextval('public.word_review_id_seq'::regclass);
...
--
-- Name: word_review word_review_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.word_review
    ADD CONSTRAINT word_review_pkey PRIMARY KEY (id);
